...
export default function Hero() {
  return (
    <div className="pt-16 pb-5 text-center lg:pt-15">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl dark:text-white">
        ...
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">EduFreeZone</span>
        </span>{" "}
        {/* for small businesses. */}
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700 dark:text-slate-300 ">
        Achieve quick and seamless access to a wealth of educational materials
        and tools right at your fingertips with EduAccessZone.
      </p>
